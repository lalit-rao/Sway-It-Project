...
import {chat, cs2Image, istg, letter, location, music, phone, playButton, twitter, yt} from "../assets/images/index.js";
                        ...
                        <div className="cc-row-cus2">
                            <div className="cc-column-cus2">
                                <div className="cc-card-cus2">
                                    ...
                                    <div className="counterCards-text-cus2">
                                        <p className="counterCards-text-inside-cus2">Jln Cempaka Wangi No 22, Jakarta -
                                            Indonesia.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="cc-column-cus2">
                                <div className="cc-card-cus2">
                                    ...
                                    <div className="counterCards-text-cus2">
                                        <p className="counterCards-text-inside-cus2">Let’s Talk For Business Enquiry or
                                            Endorsement</p>
                                    </div>
                                </div>
                            </div>
